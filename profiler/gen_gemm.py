...
from profiler.gemm_operation import GemmOperation, EmitGemmInstance
from profiler.gemm_profiler import GemmProfilerEmitter
from profiler.gen_tensor_op import ProfilerEngine, GENERATOR_FUNC_TABLE, EPILOGUE_MAP
from profiler.library import (
    DataType,
    EpilogueFunctor,
    SwizzlingFunctor,
    TensorDescription,
...
def enumerate_gemm_operators(
    ...
    for tile_description in tile_descriptions:
        for alignment in alignment_constraints:
            A = TensorDescription(element_a, LayoutType.RowMajor, alignment)
            B = TensorDescription(element_b, LayoutType.ColumnMajor, alignment)  # TODO why is this ColumnMajor?
            C = TensorDescription(element_c, LayoutType.RowMajor, alignment)
